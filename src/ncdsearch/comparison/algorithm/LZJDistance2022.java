...
/**
 * This is an implementation of algorithm published 
 * in our article (NCDSearch_evaluation_2022.pdf.
 * Lempel-Ziv Jaccard Distance proposed in <https://arxiv.org/abs/1708.03346>.
 * We extend the algorithm so that we can identify the best substring in a target code fragment.
 */
public class LZJDistance2022 implements IVariableWindowStrategy {
	 ...
	 */
	public LZJDistance2022(TokenSequence query) {
		this(query, false);
	}
	 ...
	 */
	public LZJDistance2022(TokenSequence query, boolean strict) {
		this.strict = strict;
	...
	public static void main(String[] args) {
		for (String arg: args) {
			LZJDistance2022 d = new LZJDistance2022(true);
	 ...
	 * @param strict
	 */
	private LZJDistance2022(boolean strict) {
